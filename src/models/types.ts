...
export function getTypeName(datatype: number): string {
    switch (datatype) {
        ...
        case OaElementType.DYN_BOOL:
            return 'dyn_bool';
        case OaElementType.DYN_BIT32:
            return 'dyn_bit32';
        case OaElementType.DYN_STRING:
            return 'dyn_string';
        case OaElementType.DYN_TIME:
            return 'dyn_time';
        ...
        case OaElementType.BOOL:
            return 'bool';
        case OaElementType.BIT32:
            return 'bit32';
        case OaElementType.STRING:
            return 'string';
        case OaElementType.TIME:
            return 'time';
        case OaElementType.DPID:
            return 'dpid';
        case OaElementType.DYN_DPID:
            return 'dyn_dpid';
        case OaElementType.REFERENCE:
            return 'reference';
        case OaElementType.LANGSTRING:
            return 'langstring';
        case OaElementType.BLOB:
            return 'blob';
        case OaElementType.BIT64:
            return 'bit64';
        case OaElementType.DYN_BIT64:
            return 'dyn_bit64';
        case OaElementType.LONG:
            return 'long';
        case OaElementType.DYN_LONG:
            return 'dyn_long';
        case OaElementType.ULONG:
            return 'ulong';
        case OaElementType.DYN_ULONG:
            return 'dyn_ulong';
        default:
